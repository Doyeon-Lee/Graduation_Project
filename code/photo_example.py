...
try:
    ...
    parser.add_argument("--image_path", default="../output/video/700/cropped_image/64.png", help="Process an image. Read all standard formats (jpg, png, bmp, etc.).")
    ...
    draw_img = cv2.imread("../output/video/700/cropped_image/64.png", cv2.IMREAD_COLOR)
