...
try:
    ...
    parser.add_argument("--image_path", default="../output/video/101/frames/229.png", help="Process an image. Read all standard formats (jpg, png, bmp, etc.).")
    ...
    draw_img = cv2.imread("../output/video/101/frames/229.png", cv2.IMREAD_COLOR)
